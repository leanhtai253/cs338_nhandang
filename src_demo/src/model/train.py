...
def training_model(new_data_dir, audio_ds_path, base_model_path, user_model_dir, user_weigths_dir, log_dir=None):
    ...
    new_model.fit(train_set, epochs=8, validation_data=dev_set)
